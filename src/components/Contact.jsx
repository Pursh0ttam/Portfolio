...
const Contact = () => {
  ...
  <div name='contact' className=' w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
    <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <p className='py-6'> Have any questions? <br />
        Reach out to me from this contact form and I will get back to you shortly.</p>
        </div>

        <div className='flex justify-center items-center'>
        <form action="https://getform.io/f/eae02cd6-b56d-44dc-a6da-31bf370592f7" method="POST" className='flex flex-col w-full md:w-1/2'>
        <input
        type="text" 
            name='name'
        ...
        <button className='text-white bg-gradient-to-b
                ...
                flex items-center rounded-md hover:scale-110 duration-300'>Let's 
                talk
         </button>
